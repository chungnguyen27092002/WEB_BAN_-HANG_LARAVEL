										...
										<div class="item-info-product mt-2">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form>
													@csrf
													<fieldset> 
														<input type="button" data-toggle="modal" data-target="#xemnhanh" style="background: #fff"  value="@lang('lang.quickview')" class="btn btn-default xemnhanh" data-id_soluong="{{$s->soluong}}" data-id_product="{{$s->product_id}}">
													</fieldset>
												</div>
