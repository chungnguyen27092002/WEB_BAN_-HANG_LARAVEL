$(document).ready(function (e) {
    ...
    $(document).on("click", ".add-to-cart-quickview", function () {
        ...
        var size = $("input[name='size']:checked").val() || 'Không có kích thước';
        ...
        if (parseInt(soluong) > parseInt(sl)) {
            toastr.warning(
                "số lượng bạn đặt lớn hơn số sản phẩm mà chúng tôi có, làm ơn đặt số lượng nhỏ hơn" +
                    " " +
                    sl
            );
        } else {
    ...
    $(".xemnhanh").click(function () {
        ...
        $.ajax({
            ...
            data: { product_id: product_id, _token: _token },
            success: function (data) {
                var size = data.product_size ? data.product_size : "Không có";
                ...
                $("#product_quickview_value").html(
                    data.product_quickview_value
                );
