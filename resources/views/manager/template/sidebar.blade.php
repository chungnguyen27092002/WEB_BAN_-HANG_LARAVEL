<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{URL::to('/trangchu')}}" class="site_title"><i class="fa fa-star"></i> <span>Quản lý !</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{URL::to('/brands')}}"><i class="fa fa-copyright"></i> Thương hiệu </a>
                  </li>
                  ...
                  @endhasrole
                  @hasrole(['admin'])
                  <li><a href="{{route('customer.index')}}"><i class="fa fa-table"></i> Customers</a>
                  </li>
                  @endhasrole
