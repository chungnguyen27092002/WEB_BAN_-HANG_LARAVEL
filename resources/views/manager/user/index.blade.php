                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                              <p><a style="margin:5px 0;font-size:13px" class="btn btn-sm btn-info" href="{{url('/update-users/'.$user->admin_id)}}">Chỉnh sửa</a></p>
                              <p><a style="margin:5px 0;font-size:13px;" class="btn btn-sm btn-danger" href="{{url('/delete-user-roles/'.$user->admin_id)}}" onclick="return confirm('Cbạn có chắc muốn xóa user này không')">Xóa user</a></p>
                            </div>
