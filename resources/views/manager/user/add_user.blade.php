									...
									<form  role="form" action="{{URL::to('store-users')}}" method="post" novalidate>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="admin_name" data-validate-length-range="3" required="required" class="form-control" placeholder="Nhập tên">
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password1" name="admin_password"  class="form-control" placeholder="nhập password" pattern=".{6,}"  title="nhập mật khẩu" required>
