...
class PostController extends Controller
{
    ...
    public function danh_muc_bai_viet(Request $request,$id){
        ...
        return view('client.danhmucbaiviet',compact('meta_desc','bra','meta_keywords','meta_title','url_canonical','slider','post_cate','category_post','share_image','com','cate','cate_post1','chinh','cate_id','post_name'));
    }
    ...
    public function bai_viet(Request $request,$post_slug){
        ...
        $bra=Brand::all();
        return view('client.baiviet',compact('cate','meta_desc','bra','meta_keywords','meta_title','url_canonical','slider','com','chinh','cate_id','name','post_by_id','related','cate_post','cate_post_id','slug'));
    }
}
