...
class ContactController extends Controller
{
    public function lien_he(Request $request){
        ...
        $bra=Brand::all();
        return view('client.contact')->with('category',$cate_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('cate_post1',$cate_post1)->with('contact',$contact)->with('com',$com)->with('cate',$cate)->with('chinh',$chinh)->with('bra',$bra);
