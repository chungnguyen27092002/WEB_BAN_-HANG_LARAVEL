...
Route::group(['prefix' => 'cli', 'namespace' => 'Client'], function () {
   ...
   Route::post('/vnpay_payment', 'CheckoutController@vnpay_payment')->name('vnpay.payment');
   Route::get('/vnpay-return', 'CheckoutController@returnPayment')->name('vnpay.return');
});
...
Route::get('/list-pro-brand/{id}', 'Client\ClientController@list_pro_brand')->name('list-pro-brand');
...
Route::post('/favorites/{product_id}', [FavoriteController::class, 'addToFavorites'])->name('favorites.add');
Route::get('/favorites/{product_id}', [FavoriteController::class, 'removeFromFavorites'])->name('favorites.remove');
...
Route::get('update-users/{id}', 'Admin\UserController@update_users')->middleware('check');
Route::post('edit-users/{id}', 'Admin\UserController@edit_users')->middleware('check');
