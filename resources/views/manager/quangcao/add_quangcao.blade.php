					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{URL::to('/store')}}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tên banner <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text"  name="quangcao_name" class="form-control" required="required" placeholder="Tên quảng cáo">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input rows="8" class="form-control" name="link" placeholder="link">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 text-center">
												<span class="btn btn-primary btn-file">
					                             <img src="{!! asset('web/images/download.png')!!}" id="imgPre" class="img-thumbnail cover" width="300px"/> <input type="file" name="hinh_quangcao" id="ful" required="required" >
					                             </span>
