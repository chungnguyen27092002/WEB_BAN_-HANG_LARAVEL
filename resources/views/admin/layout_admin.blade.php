            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img
                            src="{!! asset('public/uploads/post/767297506.jpg') !!}"></a>
                    <ul class="dropdown-menu">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-laptop nav_icon"></i>Quản lý sản phẩm<span
                        ...
                        <li>
                            <a href="#"><i class="fa fa-indent nav_icon"></i>Quản lý loại sản phẩm<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-indent nav_icon"></i>Quản lý bình luận<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Slide show<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Mã giảm giá<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Banner quảng cáo<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>quản lý bài viết<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>quản lý danh mục bài viết<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Quản lý đơn hàng<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="{{ route('chinh') }}"><i class="fa fa-envelope nav_icon"></i>Chính sách<span
                                    class="fa arrow"></span></a>
                        </li>
