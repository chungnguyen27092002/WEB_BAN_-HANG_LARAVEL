					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('add_poli')}}" method="post" enctype="multipart/form-data">
										@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea type="text" class="form-control" id="ckeditor1" name="content"></textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tóm tắt</label>
											<div class="col-md-6 col-sm-6 ">
												<textarea type="text" class="form-control" id="ckeditor" name="sumary"></textarea>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 text-center">
					                             ...
					                             <img src="{!! asset('web/images/download.png')!!}" id="imgPre" class="img-thumbnail cover" width="300px"/> <input type="file" name="image" id="ful" required="required" >
					                             </span>
											</div>
										</div>
