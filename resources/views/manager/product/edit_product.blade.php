							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('pro_update',$pro_edit->product_id)}}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Thương hiệu <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="brand_name" id="" class="form-control" >
													  @foreach($bra as $b)
													  @if($b->id==$pro_edit->brand_id)
													  <option selected value="{{$b->id}}">{{$b->brand_name}} {{$b->id}}</option>
													  @endif
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">Giá nhập hàng <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
